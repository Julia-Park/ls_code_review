...
function textToValidSentences(text) {
  let isSentence = function isValidSentence(string) {
...
function longestSentence(text) {
  ...
  let sentences = textToValidSentences(text);
  sentences.sort((a, b) => sentenceLength(b) - sentenceLength(a));

  console.log(sentences[0]);
  console.log(`\n\nThe longest sentence has ${sentenceLength(sentences[0])} words.`);
}
